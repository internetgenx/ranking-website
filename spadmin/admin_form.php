            ...
            <div class="content">
                ...
                <div class="container-fluid container-fixed-lg">
                    ...
                    <form action="admin_form.php" method="post">
                        ...
                        <hr>
                        <div class="form-group">
                            <label for="twad">Teacher Welfare and Development</label>
                            <input type="text" class="form-control" name="twad">
                        </div>
                        <div class="form-group">
                            <label for="cof">Competence of faculty</label>
                            <input type="text" class="form-control" name="cof">
                        </div>
                        <div class="form-group">
                            <label for="acadr">Academic Reputation</label>
                            <input type="text" class="form-control" name="acadr">
                        </div>
                        <div class="form-group">
                            <label for="cce">Co-curricular Education</label>
                            <input type="text" class="form-control" name="cce">
                        </div>
                        <div class="form-group">
                            <label for="sport">Sports Education</label>
                            <input type="text" class="form-control" name="sport">
                        </div>
                        <div class="form-group">
                            <label for="lse">Life Skill Education</label>
                            <input type="text" class="form-control" name="lse">
                        </div>
                        <div class="form-group">
                            <label for="iats">Individual Attention to Students</label>
                            <input type="text" class="form-control" name="iats">
                        </div>
                        <div class="form-group">
                            <label for="lmq">Leadership and Managment Quality</label>
                            <input type="text" class="form-control" name="lmq">
                        </div>
                        <div class="form-group">
                            <label for="pari">Parental Involvement</label>
                            <input type="text" class="form-control" name="pari">
                        </div>
                        <div class="form-group">
                            <label for="infra">Infrastucture Provision</label>
                            <input type="text" class="form-control" name="infra">
                        </div>
                        <div class="form-group">
                            <label for="inters">Internationalism</label>
                            <input type="text" class="form-control" name="inters">
                        </div>
                        <div class="form-group">
                            <label for="sne">Special Needs Education</label>
                            <input type="text" class="form-control" name="sne">
                        </div>
                        <div class="form-group">
                            <label for="vom">Value For Money</label>
                            <input type="text" class="form-control" name="vom">
                        </div>
                        <div class="form-group">
                            <label for="comms">Community Services</label>
                            <input type="text" class="form-control" name="comms">
                        </div>
                        <div class="form-group">
                            <label for="rbe">Research based Education</label>
                            <input type="text" class="form-control" name="rbe">
                        </div>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $sql="SELECT * FROM points ORDER BY score DESC";
