                           ...
                           <td>
                            ...
                            <td>
                                <?php 
                                 if($result['active']==0)
                                 { ?>
                                <button class="btn btn-success"> <a href="action.php?status=<?php echo $result['id'];?>" class="active" style="color:white;"> Activate </a></button>
                                <?php
                                 }
                                 if($result['active']==1)
                                 { ?>
                                <button class="btn btn-danger">  <a href="action.php?status=<?php echo $result['id'];?>" class="deactive" style="color:white;"> Dectivate </a></button>
                                  <?php
                                 }
                                ?>
                            </td>
