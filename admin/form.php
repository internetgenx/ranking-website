...
<body class="fixed-header">
    ...
    <nav class="page-sidebar" data-pages="sidebar">
        ...
        <div class="sidebar-header">
            <a href="admin_panel.html"> <img src="assets/img/logo_white.png" alt="logo" class="brand" data-src="assets/img/logo_white.png" data-src-retina="assets/img/logo_white_2x.png" width="78" height="22"> </a>
        ...
        <div class="sidebar-menu">
            ...
            <ul class="menu-items">
                ...
                <li class="">
                    <a href="#">
                        <span class="title">Detail Forms</span>
                    </a>
        ...
        <div class="header ">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="pull-left p-r-10 fs-14 font-heading hidden-md-down">
                    <span class="semi-bold"><?php $mails= $_SESSION['user_name']; 
                        $s= "SELECT * FROM ranks WHERE email='$mails'"; $da=mysqli_query($conn,$s) ; while($result=mysqli_fetch_array($da)){echo $result['schoolname']; }?></span>
                </div>
                <div class="dropdown pull-right hidden-md-down">
                    <button class="profile-dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="thumbnail-wrapper d32 circular inline">
                             <?php 
                               ...
                               $query= "SELECT * FROM ranks WHERE email='$mails' "; 
                               $data=mysqli_query($conn,$query);  
                               $total=mysqli_num_rows($data);
                               $fname="stuadmin/"."*";
                               $finfo=glob($fname);
                               if($finfo[0]=="stuadmin/default.jpg")
                               {
                                 ?>
                                  <img src="stuadmin/default.jpg" />  
                                  <?php
                                   
                                   $qu="UPDATE ranks SET picsource='stuadmin/default.jpg' WHERE email='$mails'";
                    ...
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown" role="menu">
                        <a href="settings.php" class="dropdown-item"><i class="pg-settings_small"></i> Settings</a>
        ...
        <div class="page-content-wrapper">
            ...
            <div class="content">
                ...
                <div class="container-fluid container-fixed-lg">
                    ...
                    <div class="wrapper" style="margin:4% 15%;">
                        <form action="form.php" method="post">
                            <div class="form-group">
                                <label for="nosd">Total Number of Students</label>
                                <input type="text" class="form-control" name="nosd">
                            </div>
                            <div class="form-group">
                                <label for="nost">Number of Students/Teacher</label>
                                <input type="text" class="form-control" id="nost" name="nost">
                            </div>
                            <h3 class="academics">Academics</h3>
                            <hr>
                            <div class="class__group" id="dynamic_field">
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="nosc">Number of Students</label>
                                    <input type="text" class="form-control" id="nosc" name="nosc">
                                </div>
                                <div class="row clearfix">
                                    <div class="form-group col-md-4">
                                        <label for="inputCity">Highest Marks</label>
                                        <input type="text" class="form-control" id="inputCity" name="city">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputState">Lowest Marks</label>
                                        <input type="text" class="form-control" id="inputCity" name="state">
                                    </div>
                                    <div class="form-group col-md-4">
                                        <label for="inputZip">Average Marks</label>
                                        <input type="text" class="form-control" id="inputZip" name="pin">
                                    </div>
                                </div>
                                <div class="sub">
                                    <h4 class="subhead">List of Subjects Taught</h4>
                                            <div class="form-group">
                                                <label for="sublist">Subjects</label>
                                                <input type="text" class="form-control" id="sublist" name="sublist">
                                            </div>

                                    </div>
                            </div>
                            <button type="button" class="btn btn-primary" name="add" id="add">Add Class</button>
                            <br>
                            <br>
                            <br>
                            <h3 class="theading">Teacher's Qualification</h3>
                            <hr>
                            <div class="teacher__group">
                                <div class="form-group">
                                    <label for="nost">Total Number of Teachers</label>
                                    <input type="text" class="form-control" id="nost" name="nost">
                                </div>
                                <div class="form-group">
                                    <label for="minq">Minimum Qualification of teachers</label>
                                    <input type="text" class="form-control" id="minq" name="minq">
                                </div>
                                <div class="form-group">
                                    <label for="maxq">Maximum Qualification of teachers</label>
                                    <input type="text" class="form-control" id="maxq" name="maxq">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="">Number of teachers with 12<sup>th</sup>pass</label>
                                <input type="text" class="form-control" id="nost" name="nost">
                            </div>
                            <div class="form-group">
                                <label for="nosc">Number of teachers with Graduation </label>
                                <input type="text" class="form-control" id="nost" name="nost">
                            </div>
                            <div class="form-group">
                                <label for="nosc">Number of teachers with Post Graduation </label>
                                <input type="text" class="form-control" id="nost" name="nost">
                            </div>
                            <div class="form-group">
                                <label for="nosc">Number of teachers with Doctorate</label>
                                <input type="text" class="form-control" id="nost" name="nost">
                            </div>
                            <div class="form-group">
                                <label for="nonat">Number of National award winning teachers</label>
                                <input type="text" class="form-control" id="box" name="nonat" value="" oninput="function();">
                            </div>
                            <div id="holder">
                                <!--<div class="form-group">
                                    <label for="nosc">Name of Teacher</label>
                                    <input type="text" class="form-control" id="nost" name="nost">
                                </div>
                            <div class="form-group">
                                    <label for="nosc">Name of Award</label>
                                    <input type="text" class="form-control" id="nost" name="nost">
                                </div>
                            <div class="form-group">
                                    <label for="nosc">Year</label>
                                    <input type="text" class="form-control" id="nost" name="nost">
                                </div>-->
                            </div>
                            <div class="form-group">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#add').click(function() {
                i++;
                $('#dynamic_field').append('<div class="class__group" id="row' + i + '"><div class="form-group"><label for="cl">Class</label><select id="cl" class="form-control" name="cl"><option value="null">Select Class</option><option value="playgroup">Playgroup</option><option value="nur">Nursery</option><option value="lkg">LKG</option><option value="ukg">UKG</option><option value="1">1st Standard</option><option value="2">2nd Standard</option><option value="3">3rd Standard</option><option value="4">4th Standard</option><option value="5">5th Standard</option><option value="6">6th Standard</option><option value="7">7th Standard</option><option value="8">8th Standard</option><option value="9">9th Standard</option><option value="10">10th Standard</option><option value="11">11th Standard</option><option value="12">12th Standard</option></select></div><div class="form-group"><label for="nosc">No of Students</label><input type="text" class="form-control" id="nosc" name="nosc"></div><div class="row clearfix"><div class="form-group col-md-4"><label for="inputCity">Highest Marks</label><input type="text" class="form-control" id="inputCity" name="city"></div><div class="form-group col-md-4"><label for="inputState">Lowest Marks</label><input type="text" class="form-control" id="inputCity" name="state"></div><div class="form-group col-md-4"><label for="inputZip">Average Marks</label><input type="text" class="form-control" id="inputZip" name="pin"></div></div><div class="sub"><h5 class="subhead">List of Subjects Taught</h5><hr /><div class="sub__group"><div class="form-group"><label for="sublist">Subjects</label><input type="text" class="form-control" id="sublist" name="sublist"></div></div></div><div class="form-group"><button type="button" name="remove" id="' + i + '" class="btn btn-danger btn_remove">Remove Class</button></div></div>');
            });
            ...
            /*$("#addsub").click(function() {
                j++;
                $('#dynamic_field1').append('<div class="sub__group" id="rowsub' + j + '"> <div class="form-group" ><label for="sublist">Subject <span>' + j + '</span></label><input type="text" class="form-control" id="sublist" name="sublist"><div class="form-group"><button type="button" name="remove" id="' + j + '" class="btn btn-danger btn_removesub">Remove Subject</button></div></div></div>');
            });
            ...
            $("#box").on('input', function() {
                ...
                var requested = parseInt(document.getElementById("box").value);

                if (requested > count) {
                    for (i = count; i < requested; i++) {
                        var $ctrl = $('<div id="boxes-' + i +'"><label for="name">Name</label><br><input id="name-' + i + '" name="name-' + i + '" type="text" style="width:100%;"/><br><br><label for="noa">Name of Award</label><br><input id="noa-' + i + '" name="noa-' + i + '" type="text" style="width:100%;"/><br><br><label for="year">Year</label><br><input id="year-' + i + '" name="year-' + i + '" type="text" style="width:100%;"/><br><br></div>');
                        $("#holder").append($ctrl);
                    }
                } 
                else if (requested < count) {
                    var x = requested - 1;
                    $("#holder div:gt(" + x + ")").remove();
                }
