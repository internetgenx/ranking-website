    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
                ...
                <div class="container-fluid container-fixed-lg">
                    ...
                    <form action="settings.php" method="post">
                        <div class="form-group">
                            ...
                            <hr>
                            <input type="password" class="form-control" name="chpass">
                            <button type="submit" class="btn btn-primary" name="chpwd" id="add">Update</button>
                        </div>
                    </form>
                    <form action="settings.php" method="post">
                        <div class="form-group">
                            ...
                            <hr>
                            <input type="text" class="form-control" name="chphno">
                            <button type="submit" class="btn btn-primary" name="chpn" id="add">Update</button>
                        </div>
                    </form>
                    <form action="settings.php" method="post">
                        <div class="form-group">
                            <h4>Change Contact Person Name</h4>
                            <hr>
                            <input type="text" class="form-control" name="chcatname">
                            <button type="submit" class="btn btn-primary " name="chname" id="add">Update</button>
                        </div>
                    </form>
                    <?php
            ...
            if(isset($_POST['chpwd']))
            {
             ...
             $query="UPDATE ranks SET password='$pwd' WHERE email='$mails'";
            ...
            if(isset($_POST['chpn']))
            {
             ...
             $query="UPDATE ranks SET phone='$pwd' WHERE email='$mails'";
            ...
            if(isset($_POST['chname']))
            {
             ...
             $query="UPDATE ranks SET contactperson='$pwd' WHERE email='$mails'";
